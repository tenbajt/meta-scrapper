    ...
    <body class="max-w-7xl mx-auto py-8 px-4 sm:px-6">
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="grid grid-cols-[1fr,auto] items-center">
                ...
                <div class="text-xs">
                    <span class="<?= $session->flash('title_count_error', false) ? 'text-red-500' : '' ?>">
                        <?= $session->flash('title_count', 0) ?>
                    </span>
                    /75 znaków | 0/600 pikseli
                </div>
            ...
            <div class="grid grid-cols-[1fr,auto] items-center">
                ...
                <div class="text-xs">
                    <span class="<?= $session->flash('desc_count_error', false) ? 'text-red-500' : '' ?>">
                        <?= $session->flash('desc_count', 0) ?>
                    </span>
                    /160 znaków | 0/1000 pikseli
                </div>
